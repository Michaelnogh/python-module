...
#list
# my_list = ["bob" , "Rolf" , "Dani"]
# print(my_list)

# # Tuple - סוג נוסף של רשימה אבל מגדיירם אותו עם סוגריים רגילים
# my_tuple =("bob", "Rolf" , "Anne")
# print(my_tuple)

# #Set 
# my_set = {"bob", "rolf" , "muhi"}
# print(my_set)


# Changing Index (BOB to Smith)
my_list = ["bob" , "Rolf" , "Dani"]
print(my_list)
my_list[0] = "Smith"
print(my_list)
...
# name = "Mickey"
# # name[0] = "S" #! Expect to get Sickey but wont work cuase strings are immutable
