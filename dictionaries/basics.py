...
# for n in student_attendance:
#     print(n)
# student_attendance = {
#     "Rolf": 96,
#     "Bob": 80

# for studnet in student_attendance:
#     print(studnet+str(student_attendance[studnet]))
...
# for i in student_attendance.values():
#    total = student_attendance.values()
#    x = (sum(total))
#    y = (len(total))
